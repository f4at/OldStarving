    ...
    function g(f) {
        function d(e, g, p) {
            ...
            if ("undefined" !== typeof document) {
                ...
                e || (n = {});
                for (var r = document.cookie ? document.cookie.split("; ") : [], u = /(%[0-9A-Z]{2})+/g, q = 0; q < r.length; q++) {
                    var v = r[q].split("=")
                      , t = v.slice(1).join("=");
                    '"' === t.charAt(0) && (t = t.slice(1, -1));
                    try {
                        var z = v[0].replace(u, decodeURIComponent)
                          , t = f.read ? f.read(t, z) : f(t, z) || t.replace(u, decodeURIComponent);
                        if (this.json)
                            try {
                                t = JSON.parse(t);
                            } catch (A) {}
...
function create_minimap_object(c, g, f, d, e, m, p) {
    p = void 0 === p ? 0 : p;
    for (var n = -1 == m ? 0 : m; n >= p; n--)
        for (var r = 0; 300 > r; r++)
            for (var u = 0; 100 > u; u++) {
                var q = MAP.tiles[u][r];
                if (q)
                    for (var q = -1 == m ? q[d] : q[d][n], v = 0; v < q.length; v++) {
                        var t = q[v];
                        c.fillStyle = f;
...
function create_craft_button(c, g, f, d, e) {
    ...
    for (v = 0; v < d.length; v++)
        ...
        g.height = r + q,
        f.globalAlpha = e / 2,
        2 == v ? round_rect(f, 0, q, n, r, u) : round_rect(f, 0, 0, n, r + q, u),
        fill_path(f, "#081a19"),
        f.globalAlpha = e,
        2 == v ? round_rect(f, 0, q, n, r, u) : round_rect(f, 0, 0, n, r, u),
        fill_path(f, d[v]),
        f.globalAlpha = 1,
        2 == v ? f.drawImage(m, 0, q) : f.drawImage(m, 0, 0),
        c.push(CTI(g));
    return c;
}
...
function create_tree_branch(c, g, f) {
    ...
    fill_path(e, g[5]),
    e.translate(-70 * c, 0),
    round_rect(e, -15 * c, -2 * c, 60 * c, 60 * c, u)) : (d.width = m,
    d.height = p,
    e.save(),
    e.globalAlpha = .5,
...
function create_images() {
    ...
    sprite[SPRITE.PICK_AMETHYST][SPRITE.DAY] = CTI(create_rotated_img(4, create_pickaxe(.75, !0, "#0d1b1c #000000 #0d1b1c #262114 #211108 #b864d6 #8c29aa".split(" "))));
    sprite[SPRITE.PICK_AMETHYST][SPRITE.NIGHT] = CTI(create_rotated_img(4, create_pickaxe(.75, !0, "#030d14 #000000 #030d14 #111316 #0a0b0c #8359d3 #764eb5".split(" "))));
    sprite[SPRITE.SWORD] = [];
    sprite[SPRITE.SWORD][SPRITE.DAY] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#4d2d14", "#432516", "#939393", "#5f6061"])));
    sprite[SPRITE.SWORD][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#0d2e33", "#0b2326", "#485e66", "#1f343f"])));
    sprite[SPRITE.SWORD_GOLD] = [];
    sprite[SPRITE.SWORD_GOLD][SPRITE.DAY] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#493e26", "#382e19", "#c4bc51", "#b29c32"])));
    sprite[SPRITE.SWORD_GOLD][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#263947", "#182935", "#43aa82", "#29997c"])));
    sprite[SPRITE.SWORD_DIAMOND] = [];
    sprite[SPRITE.SWORD_DIAMOND][SPRITE.DAY] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#262114", "#211108", "#63c9d6", "#29aaa1"])));
    sprite[SPRITE.SWORD_DIAMOND][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#111316", "#0a0b0c", "#73dde5", "#3dc4c0"])));
    sprite[SPRITE.SWORD_AMETHYST] = [];
    sprite[SPRITE.SWORD_AMETHYST][SPRITE.DAY] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#262114", "#211108", "#b864d6", "#8c29aa"])));
    sprite[SPRITE.SWORD_AMETHYST][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_sword(.42, !0, ["#0d1b1c", "#111316", "#0a0b0c", "#8359d3", "#764eb5"])));
    ...
    sprite[SPRITE.AMETHYST_WALL][SPRITE.DAY] = CTI(create_wall_stone(1, !0, "#0d1b1c #b15ecf #8c29aa #c26de0 #af59cd #d588f1".split(" ")));
    sprite[SPRITE.AMETHYST_WALL][SPRITE.NIGHT] = CTI(create_wall_stone(1, !0, "#030d14 #8359d3 #764eb5 #8f65de #7f55cc #9d77e6".split(" ")));
    ...
    sprite[SPRITE.AMETHYST_SPIKE][SPRITE.DAY] = CTI(create_spike_stone(1, !0, "#0d1b1c #6a7570 #939393 #b15ecf #8c29aa #c26de0 #af59cd #d588f1".split(" ")));
    sprite[SPRITE.AMETHYST_SPIKE][SPRITE.NIGHT] = CTI(create_spike_stone(1, !0, "#030d14 #1f343f #485e66 #8359d3 #764eb5 #8f65de #7f55cc #9d77e6".split(" ")));
    ...
    sprite[SPRITE.DOOR_AMETHYST_CLOSE][SPRITE.DAY] = CTI(create_door_stone(1.5, !0, "#0d1b1c #b15ecf #8c29aa #c26de0 #af59cd #d588f1".split(" ")));
    sprite[SPRITE.DOOR_AMETHYST_CLOSE][SPRITE.NIGHT] = CTI(create_door_stone(1.5, !0, "#030d14 #8359d3 #764eb5 #8f65de #7f55cc #9d77e6".split(" ")));
    ...
    sprite[SPRITE.DOOR_AMETHYST_OPEN][SPRITE.DAY] = CTI(create_door_stone(1, !1, "#133a2b #133a2b #1a4935 #1a4935 #133a2b #1a4935".split(" ")));
    sprite[SPRITE.DOOR_AMETHYST_OPEN][SPRITE.NIGHT] = CTI(create_door_stone(1, !1, "#032428 #032428 #07393d #07393d #032428 #07393d".split(" ")));
    ...
    sprite[SPRITE.BLUE_CORD] = CTI(create_cord(1, !0, ["#d4e9ec", "#37b1d7", "#506c71"]));
    ...
    sprite[SPRITE.FUR_WINTER] = CTI(create_fur(1, !0, ["#ffffff", "#b6222a"]));
    ...
    sprite[SPRITE.CAP_SCARF][SPRITE.DAY] = CTI(create_cap_scarf(.6, !0, ["#171a19", "#dee7e7", "#b8cccb", "#ffffff", "#e3e8e8"]));
    sprite[SPRITE.CAP_SCARF][SPRITE.NIGHT] = CTI(create_cap_scarf(.6, !0, ["#073030", "#368981", "#1c635e", "#7bbab4", "#469e95"]));
    ...
    sprite[SPRITE.BAG] = [];
    sprite[SPRITE.BAG][SPRITE.DAY] = CTI(create_bag(.6, !1, ["#872f13", "#471e12"]));
    sprite[SPRITE.BAG][SPRITE.NIGHT] = CTI(create_bag(.6, !1, ["#0e3336", "#092626"]));
    ...
    sprite[SPRITE.AMETHYST_SPEAR][SPRITE.DAY] = CTI(create_rotated_img(3, create_spear(.6, !0, ["#0d1b1c", "#262114", "#211108", "#b864d6", "#8c29aa"])));
    sprite[SPRITE.AMETHYST_SPEAR][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_spear(.6, !0, ["#0d1b1c", "#111316", "#0a0b0c", "#8359d3", "#764eb5"])));
    ...
    sprite[SPRITE.HAMMER][SPRITE.DAY] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#4d2d14", "#432516", "#939393", "#5f6061"])));
    sprite[SPRITE.HAMMER][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#030d14", "#263947", "#182935", "#485e66", "#1f343f"])));
    ...
    sprite[SPRITE.HAMMER_GOLD][SPRITE.DAY] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#493e26", "#382e19", "#c4bc51", "#b29c32"])));
    sprite[SPRITE.HAMMER_GOLD][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#0d2e33", "#0b2326", "#43aa82", "#29997c"])));
    ...
    sprite[SPRITE.HAMMER_DIAMOND][SPRITE.DAY] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#262114", "#211108", "#63c9d6", "#29aaa1"])));
    sprite[SPRITE.HAMMER_DIAMOND][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#111316", "#0a0b0c", "#73dde5", "#3dc4c0"])));
    ...
    sprite[SPRITE.HAMMER_AMETHYST][SPRITE.DAY] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#262114", "#211108", "#b864d6", "#8c29aa"])));
    sprite[SPRITE.HAMMER_AMETHYST][SPRITE.NIGHT] = CTI(create_rotated_img(3, create_hammer(1, !0, ["#0d1b1c", "#111316", "#0a0b0c", "#8359d3", "#764eb5"])));
    ...
    sprite[SPRITE.EXPLORER_HAT][SPRITE.DAY] = CTI(create_explorer_hat(.55, !0, "#c9a65f #ae863f #655530 #4a391c #ebdd79 #4a421c".split(" ")));
    sprite[SPRITE.EXPLORER_HAT][SPRITE.NIGHT] = CTI(create_explorer_hat(.55, !0, "#15514f #0f3f3d #123335 #0d2d2b #2b6664 #070d16".split(" ")));
    ...
    sprite[SPRITE.STONE_HELMET][SPRITE.DAY] = CTI(create_viking_hat(.58, !0, "#252525 #9b8251 #5e4a2d #737373 #4f4f4f #8c7542".split(" ")));
    sprite[SPRITE.STONE_HELMET][SPRITE.NIGHT] = CTI(create_viking_hat(.58, !0, "#15514f #216661 #0f3f3d #295957 #0f3f3d #1c5e5b".split(" ")));
    ...
    sprite[SPRITE.GOLD_HELMET][SPRITE.DAY] = CTI(create_gold_helmet(.58, !0, ["#dbce71", "#b29c32", "#c4bc51"]));
    sprite[SPRITE.GOLD_HELMET][SPRITE.NIGHT] = CTI(create_gold_helmet(.58, !0, ["#2b7c57", "#15543c", "#1a7961"]));
    ...
    sprite[SPRITE.DIAMOND_HELMET][SPRITE.DAY] = CTI(create_diamond_helmet(.69, !0, "#717171 #485252 #555555 #65c7cd #4aadad #358d8b #c1e6ea #a6dce4".split(" ")));
    sprite[SPRITE.DIAMOND_HELMET][SPRITE.NIGHT] = CTI(create_diamond_helmet(.69, !0, "#183f3f #092121 #123335 #2b9390 #277a74 #1f665f #83ddd4 #59c9c0".split(" ")));
    ...
    sprite[SPRITE.BOOK] = [];
    sprite[SPRITE.BOOK][SPRITE.DAY] = CTI(create_rotated_img(2.2, create_book(.2, !0, "#511f00 #2f1300 #ffffff #d4d4d4 #5b2400 #984e21".split(" "))));
    sprite[SPRITE.BOOK][SPRITE.NIGHT] = CTI(create_rotated_img(2.2, create_book(.2, !0, "#183f3f #092121 #63bec4 #0e3c37 #1e4f52 #2e6c70".split(" "))));
    ...
    sprite[SPRITE.PAPER] = CTI(create_paper(.5, !0, ["#221e1b", "#ffffff", "#f6f0e7"]));
    ...
    sprite[SPRITE.HERB_WINTER][SPRITE.DAY].push(CTI(create_herb(.9, !1, ["#f9f9f9"], 0)));
    sprite[SPRITE.HERB_WINTER][SPRITE.DAY].push(CTI(create_herb(.9, !1, ["#f9f9f9"], 1)));
    sprite[SPRITE.HERB_WINTER][SPRITE.DAY].push(CTI(create_herb(.9, !1, ["#f9f9f9"], 2)));
    sprite[SPRITE.HERB_WINTER][SPRITE.NIGHT].push(CTI(create_herb(.9, !1, ["#156a70"], 0)));
    sprite[SPRITE.HERB_WINTER][SPRITE.NIGHT].push(CTI(create_herb(.9, !1, ["#156a70"], 1)));
    sprite[SPRITE.HERB_WINTER][SPRITE.NIGHT].push(CTI(create_herb(.9, !1, ["#156a70"], 2)));
    ...
    sprite[SPRITE.AMETHYST][SPRITE.DAY].push(CTI(create_amethyst(1.7, !1, ["#1d051e", "#c27add", "#cd98e5"])));
    sprite[SPRITE.AMETHYST][SPRITE.DAY].push(CTI(create_amethyst(1.5, !1, ["#1d051e", "#c27add", "#cd98e5"])));
    sprite[SPRITE.AMETHYST][SPRITE.DAY].push(CTI(create_amethyst(1.3, !1, ["#1d051e", "#c27add", "#cd98e5"])));
    sprite[SPRITE.AMETHYST][SPRITE.NIGHT].push(CTI(create_amethyst(1.7, !1, ["#123d38", "#41aaa0", "#5cccc4"])));
    sprite[SPRITE.AMETHYST][SPRITE.NIGHT].push(CTI(create_amethyst(1.5, !1, ["#123d38", "#41aaa0", "#5cccc4"])));
    sprite[SPRITE.AMETHYST][SPRITE.NIGHT].push(CTI(create_amethyst(1.3, !1, ["#123d38", "#41aaa0", "#5cccc4"])));
    sprite[SPRITE.SNOW] = [];
    ...
    sprite[SPRITE.DOOR_WOOD_OPEN_WINTER][SPRITE.DAY] = CTI(create_door_wood(1, !1, "#EBF2F0 #EBF2F0 #b2d4d1 #b2d4d1 #EBF2F0 #b2d4d1".split(" ")));
    sprite[SPRITE.DOOR_WOOD_OPEN_WINTER][SPRITE.NIGHT] = CTI(create_door_wood(1, !1, "#136167 #136167 #24878f #24878f #136167 #24878f".split(" ")));
    sprite[SPRITE.DOOR_STONE_OPEN_WINTER] = [];
    sprite[SPRITE.DOOR_STONE_OPEN_WINTER][SPRITE.DAY] = CTI(create_door_stone(1, !1, "#EBF2F0 #EBF2F0 #b2d4d1 #b2d4d1 #EBF2F0 #b2d4d1".split(" ")));
    sprite[SPRITE.DOOR_STONE_OPEN_WINTER][SPRITE.NIGHT] = CTI(create_door_stone(1, !1, "#136167 #136167 #24878f #24878f #136167 #24878f".split(" ")));
    sprite[SPRITE.DOOR_AMETHYST_OPEN_WINTER] = [];
    sprite[SPRITE.DOOR_AMETHYST_OPEN_WINTER][SPRITE.DAY] = CTI(create_door_stone(1, !1, "#EBF2F0 #EBF2F0 #b2d4d1 #b2d4d1 #EBF2F0 #b2d4d1".split(" ")));
    sprite[SPRITE.DOOR_AMETHYST_OPEN_WINTER][SPRITE.NIGHT] = CTI(create_door_stone(1, !1, "#136167 #136167 #24878f #24878f #136167 #24878f".split(" ")));
    sprite[SPRITE.DOOR_DIAMOND_OPEN_WINTER] = [];
    sprite[SPRITE.DOOR_DIAMOND_OPEN_WINTER][SPRITE.DAY] = CTI(create_door_diamond(1, !1, "#EBF2F0 #EBF2F0 #b2d4d1 #b2d4d1 #EBF2F0 #b2d4d1".split(" ")));
    sprite[SPRITE.DOOR_DIAMOND_OPEN_WINTER][SPRITE.NIGHT] = CTI(create_door_diamond(1, !1, "#136167 #136167 #24878f #24878f #136167 #24878f".split(" ")));
    sprite[SPRITE.DOOR_GOLD_OPEN_WINTER] = [];
    sprite[SPRITE.DOOR_GOLD_OPEN_WINTER][SPRITE.DAY] = CTI(create_door_gold(1, !1, "#EBF2F0 #EBF2F0 #b2d4d1 #b2d4d1 #EBF2F0 #b2d4d1".split(" ")));
    sprite[SPRITE.DOOR_GOLD_OPEN_WINTER][SPRITE.NIGHT] = CTI(create_door_gold(1, !1, "#136167 #136167 #24878f #24878f #136167 #24878f".split(" ")));
    sprite[SPRITE.FOX] = [];
...
function draw_minimap() {
    ...
    g && (ctx.fillStyle = world.time ? "#fff" : "#1e8a9d",
...
function draw_leaderboard() {
    ...
    if (c.update) {
        ...
        for (var m = 0; m < c.length; m++) {
            var p = d[c[m]];
            if (world.mode != WORLD.MODE_HUNGER_GAMES || "spectator" != p.nickname)
                c[m] == user.id ? (e = !0,
                color = "#FFF") : color = "#A1BDCD",
                f.drawImage(create_text(scale, "" + (m + 1), 15 * scale, color), 20 * scale, (40 + 22 * m) * scale),
                p.ldb_label || (p.ldb_label = create_text(scale, p.nickname, 15 * scale, color, void 0, void 0, void 0, void 0, 110 * scale)),
...
function draw_ui_inventory() {
    for (var c = user.inv, g = world.fast_units[user.uid], f = 0; f < c.can_select.length; f++) {
        var d = c.can_select[f]
          , e = !1;
        c.id == d.id || g && g.clothe == d.id && 0 < g.clothe ? (e = !0,
        ctx.drawImage(d.info.img[2], d.info.translate.x, d.info.translate.y)) : d.draw(ctx);
        var m = user.inv.n[d.id];
        1 < m && draw_amount(m, d);
        0 < m && draw_slot_number(f, d, e);
        e = user.chest;
...
function draw_dragon() {
    ...
    this.action & STATE.HURT && (ctx.globalAlpha = .6 - this.hit.v,
...
function draw_player() {
    ...
    ctx.restore();
    this.x > SPRITE.WINTER_BIOME_Y ? (this.player.label_winter || (this.player.label_winter = create_text(scale, this.player.nickname, 20, "#187484", "#000", 2)),
    f = this.player.label_winter) : (this.player.label || (this.player.label = create_text(scale, this.player.nickname, 20, "#FFF", "#000", 2)),
    f = this.player.label);
...
function draw_map_objects(c, g, f, d, e, m, p, n) {
    for (n = void 0 === n ? 0 : n; p >= n; p--)
        for (var r = c; r <= g; r++)
            for (var u = f; u <= d; u++) {
                var q = MAP.tiles[r][u];
                if (q)
                    for (var q = q[m][p], v = 0; v < q.length; v++) {
                        var t = q[v];
                        if (t.update) {
                            t.hit.update() && 0 == t.hit.o && (t.update = !1);
                            var z = (1 - t.hit.v) * delta * 600 * scale
                              , A = Math.cos(t.angle) * z
                              , z = Math.sin(t.angle) * z;
                        } else
                            z = A = 0;
...
function draw_map_object(c, g, f, d, e, m) {
    for (; c <= g; c++)
        for (var p = f; p <= d; p++) {
            var n = MAP.tiles[c][p];
            if (n)
                for (var n = n[m], r = 0; r < n.length; r++) {
                    var u = n[r];
                    if (u.update) {
                        u.hit.update() && 0 == u.hit.o && (u.update = !1);
                        var q = (1 - u.hit.v) * delta * 600 * scale
                          , v = Math.cos(u.angle) * q
                          , q = Math.sin(u.angle) * q;
                    } else
                        q = v = 0;
                    var t = sprite[e][world.time];
                    ctx.drawImage(t, user.cam.x + u.x - t.width / 2 + v, user.cam.y + u.y - t.height / 2 + q);
                }
        }
}
function draw_world() {
    ...
    for (var e = world.units[ITEMS.PLAYERS], m = 0; m < e.length; m++)
        for (var p = e[m], n = 0; n < p.foot.length; n++)
            draw_foot(p.foot[n]);
    n = world.units[ITEMS.FURNACE];
    for (m = 0; m < n.length; m++)
        2 == n[m].action && draw_bg_transition(n[m]);
    ...
    for (m = 0; m < n.length; m++)
        n[m].info && (n[m].x < SPRITE.WINTER_BIOME_Y ? draw_transition(n[m], SPRITE.DOOR_WOOD_OPEN) : draw_transition(n[m], SPRITE.DOOR_WOOD_OPEN_WINTER));
    n = world.units[ITEMS.STONE_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info && (n[m].x < SPRITE.WINTER_BIOME_Y ? draw_transition(n[m], SPRITE.DOOR_STONE_OPEN) : draw_transition(n[m], SPRITE.DOOR_STONE_OPEN_WINTER));
    n = world.units[ITEMS.GOLD_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info && (n[m].x < SPRITE.WINTER_BIOME_Y ? draw_transition(n[m], SPRITE.DOOR_GOLD_OPEN) : draw_transition(n[m], SPRITE.DOOR_GOLD_OPEN_WINTER));
    n = world.units[ITEMS.DIAMOND_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info && (n[m].x < SPRITE.WINTER_BIOME_Y ? draw_transition(n[m], SPRITE.DOOR_DIAMOND_OPEN) : draw_transition(n[m], SPRITE.DOOR_DIAMOND_OPEN_WINTER));
    n = world.units[ITEMS.AMETHYST_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info && (n[m].x < SPRITE.WINTER_BIOME_Y ? draw_transition(n[m], SPRITE.DOOR_AMETHYST_OPEN) : draw_transition(n[m], SPRITE.DOOR_AMETHYST_OPEN_WINTER));
    ...
    if (world.mode === WORLD.MODE_PVP)
        ...
        for (m = 0; m < e.length; m++)
            "spectator" === world.players[user.id].nickname ? e[m].draw() : "spectator" !== e[m].player.nickname && e[m].draw();
    ...
    n = world.units[ITEMS.WOOD_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info || draw_transition(n[m], SPRITE.DOOR_WOOD_CLOSE);
    n = world.units[ITEMS.STONE_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info || draw_transition(n[m], SPRITE.DOOR_STONE_CLOSE);
    n = world.units[ITEMS.GOLD_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info || draw_transition(n[m], SPRITE.DOOR_GOLD_CLOSE);
    n = world.units[ITEMS.DIAMOND_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info || draw_transition(n[m], SPRITE.DOOR_DIAMOND_CLOSE);
    n = world.units[ITEMS.AMETHYST_DOOR];
    for (m = 0; m < n.length; m++)
        n[m].info || draw_transition(n[m], SPRITE.DOOR_AMETHYST_CLOSE);
    ...
    n = world.units[ITEMS.FURNACE];
    for (m = 0; m < n.length; m++)
        2 == n[m].action && draw_fg_transition(n[m]);
    ...
    if (world.mode === WORLD.MODE_PVP)
        ...
        for (m = 0; m < e.length; m++)
            "spectator" === world.players[user.id].nickname ? e[m].draw_text() : "spectator" !== e[m].player.nickname && e[m].draw_text();
}
...
function draw_imgs_transition(c, g, f, d, e) {
    world.transition && 1 == e ? (ctx.globalAlpha = 1,
    ctx.drawImage(sprite[c][world.time][g], f, d),
    world.time = world.time ? 0 : 1,
    ctx.globalAlpha = 1 - world.shade.v,
    ctx.drawImage(sprite[c][world.time][g], f, d),
    world.time = world.time ? 0 : 1) : (ctx.globalAlpha = e,
    ctx.drawImage(sprite[c][world.time][g], f, d));
    ctx.globalAlpha = 1;
}
...
function draw_map_transition(c, g, f, d, e, m, p, n) {
    ...
    c(g, f, d, e, m, p, n),
    world.time = world.time ? 0 : 1,
    ctx.globalAlpha = 1) : c(g, f, d, e, m, p, n);
}
...
function draw_ground() {
    if (-user.cam.x <= SPRITE.WINTER_BIOME_Y) {
        ...
        0 <= c ? ctx.fillRect(0, 0, canw - c, canh) : ctx.fillRect(0, 0, canw, canh);
    }
    -user.cam.x + canw >= SPRITE.WINTER_BIOME_Y && (world.transition ? (c = world.time ? 1 - world.shade.v : world.shade.v,
    ctx.fillStyle = get_color_transition(19, 97, 103, 235, 242, 240, c)) : ctx.fillStyle = SPRITE.SNOW_GROUND[world.time],
    c = SPRITE.WINTER_BIOME_Y + user.cam.x,
    0 < c ? ctx.fillRect(c, 0, canw - c, canh) : ctx.fillRect(0, 0, canw, canh));
}
function draw_winter() {
    for (var c = user.winter, g = c.flakes, f = 0; f < g.length; f++) {
        var d = g[f];
        c.update(d);
    ...
    for (f = 0; f < g.length; f++)
        d = g[f],
        (0 >= d.life || d.x > -user.cam.x + user.cam.w || d.x < -user.cam.x || d.y > -user.cam.y + user.cam.h) && g.splice(f, 1);
    g = -user.cam.x + user.cam.w;
    g >= SPRITE.WINTER_BIOME_Y && c.add(g);
}
...
function Client() {
    ...
    this.build_stop = function() {
        user.craft.id2 == INV.BAG ? user.inv.max = 10 : this.gather([0, user.craft.id2, 1]);
        user.craft.restart();
    }
    ;
    ...
    this.gather = function(c) {
        for (var f = c.length, d = user.inv, e = 1; e < f; e += 2) {
            for (var m = c[e], p = c[e + 1], n = 0; n < d.can_select.length; n++)
                if (d.can_select[n].id == m) {
                    d.n[m] += p;
                    break;
                }
            n == d.can_select.length && (d.n[m] = p,
    ...
    this.hitten_other = function(c, f) {
        for (var d = new Uint16Array(f), e = (c.length - 2) / 4, m = 0; m < e; m++) {
            var p = c[5 + 4 * m] / 255 * Math.PI * 2
              , n = world.fast_units[c[4 + 4 * m] * world.max_units + d[1 + 2 * m]];
            n && n.hit && (n.hit.angle = p,
            n.hit.update = p);
        }
    }
    ;
    ...
    this.units = function(c, f, d) {
        ...
        for (var e = 0; e < d; e++) {
            ...
            if (r & STATE.DELETE)
                ...
                world.fast_units[q] ? (q = world.fast_units[q],
                q.r.x = t,
                q.r.y = z,
                0 != n && Utils.dist(q, q.r) > CLIENT.LAG_DISTANCE && (q.x = t,
                q.y = z),
                q.id != user.id && (q.nangle = m),
                q.action |= r,
                q.info = p,
                q.update && q.update(r)) : (n = new Item(v,n,u,t,z,m,r,p),
    ...
    this.update_cam = function() {
        if (old_timestamp - this.cam_delay > CLIENT.CAM_DELAY) {
            ...
            var c = user.cam
              , f = Math.floor(c.x / 100)
              , d = Math.floor(c.y / 100);
    ...
    this.handshake = function(c) {
        ...
        user.craft.fire = !1;
        user.craft.timeout = new Utils.LinearAnimation(!1,0,1,0,1,1);
        world.mode = c[8];
        world.time = c[7];
        world.transition = !1;
        user.day = 0;
...
function Item(c, g, f, d, e, m, p, n) {
    ...
    case ITEMS.PLAYERS:
        ...
        this.update = function() {
            ...
            this.info & 16384 ? (this.info &= -16385,
...
function World(c) {
        ...
        for (var f = 0; f < this.nw; f++) {
            ...
            if (d) {
                for (k = 0; k < d.p.length; k++)
                    d.p[k].hit = new Utils.LinearAnimation(!1,1,1,0,10,10),
                    d.p[k].update = !1,
                    d.p[k].time = 0,
                    d.p[k].angle = 0;
                g(d, "t", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "s", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "g", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "d", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "b", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "f", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "sw", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "gw", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "dw", new Utils.LinearAnimation(!1,1,1,0,10,10));
                g(d, "a", new Utils.LinearAnimation(!1,1,1,0,10,10));
            }
        }
    ...
    this.delete_units = function(c) {
        if (this.fast_units[c]) {
            ...
            for (var d = this.units[type], f = 0; f < d.length; f++)
                if (d[f].uid == c) {
                    d.splice(f, 1);
                    break;
                }
    ...
    this.move_units = function(c, d, f, g, r) {
        for (var u = 0; u < c.length; u++) {
            ...
            if (b.foot_enable) {
                q = b.foot;
                v = q.length;
                if (b.x > SPRITE.WINTER_BIOME_Y + 20 * scale && (0 === v || Utils.dist(q[v - 1], b) > SPRITE.STEP_SPACE)) {
                    b.id_foot++;
                    if (1 < Math.abs(b.x - b.r.x) && 1 < Math.abs(b.y - b.r.y))
                        if (b.r.x > b.x && b.r.y < b.y || b.r.x < b.x && b.r.y > b.y)
                            ...
                            b.id_foot % 2 ? (t = 11 * scale,
                            z = -11 * scale) : (z = 11 * scale,
                            t = -11 * scale);
                    else
                        b.id_foot % 2 ? (t = 15 * Math.sin(b.angle) * scale,
                        z = 15 * Math.cos(b.angle) * scale) : (t = 15 * -Math.sin(b.angle) * scale,
                ...
                0 < q.length && 0 === q[0].alpha && q.splice(0, 1);
            }
        }
    }
    ;
...
function User() {
    ...
    this.control = {
        ...
        update: function() {
            ...
            if (!mouse.state) {
                var c = world.fast_units[user.uid];
                c && !(c.action & STATE.ATTACK) && this.mouse > CLIENT.ATTACK && (this.attack = 1,
                this.mouse = 0,
            ...
            .005 < Math.abs(this.angle - g) && (client.send_angle(g),
            this.angle = g));
            user.chat.open || (c = 0,
            keyboard.is_left() && (c |= 1),
            keyboard.is_right() && (c |= 2),
            ...
            for (var c in RECIPES) {
                ...
                if (g.r) {
                    for (var d = 0; d < g.r.length; d++) {
                        if (10 === user.inv.max && g.id === CRAFT.BAG) {
                            f = !1;
                            break;
                        }
    ...
    this.alert = {
        timeout: new Utils.LinearAnimation(!1,1,1,0,4,.2),
        text: "",
        label: null,
        draw: draw_alert
    };
    ...
    this.winter = {
        flakes: [],
        update: function(c) {
            keyboard.is_bottom() ? c.y += delta * c.speed * 5.5 : c.y += delta * c.speed * 5;
            c.life -= delta / 2;
            keyboard.is_left() ? c.x += 100 * delta : keyboard.is_right() ? c.x -= 130 * delta : c.x -= 30 * delta;
            c.alpha = .2 < c.life ? Math.min(c.alpha + 3 * delta, 1) : Math.max(c.alpha - 5 * delta, 0);
        },
        add: function(c) {
            this.flakes.length < Math.floor(SPRITE.FLAKES_NUMBER * Math.max(Math.min(c - SPRITE.WINTER_BIOME_Y, 3E3) / 3E3, 0)) && this.flakes.push(new Flakes(Math.floor(Math.random() * SPRITE.FLAKES_SIZES),-user.cam.x + Math.floor(Math.random() * user.cam.w),-user.cam.y + Math.floor(400 * Math.random() * scale - 200 * scale)));
        }
    };
}
var LOADER = {
...
function Loader(c, g, f) {
    ...
    var r = function(c, d) {
      ...
      , q = function() {
        document.fonts && document.fonts.check ? document.fonts.check("1em Baloo Paaji") ? setTimeout(u, 100) : setTimeout(q, 100) : setTimeout(u, 1E3);
    };
    g = function() {}
    ;
    for (var v in IMAGES) {
...
function UI(c, g) {
    ...
    ;
    var m, p = -1, n = function() {
        f.update();
        p++;
        30 == p ? (Cookies.set("starve_nickname", f.nickname.input.value),
...
//         this.youtube.translate.y = this.play.info.translate.y - 130;
...
function Game(c, g) {
    ...
    ;
    var p, n = -1, r = function() {
        f.update();
        n++;
        30 == n ? (f.stop(),
        p()) : window.setTimeout(r, 33);
    };
    this.is_run = !1;
    this.stop = function() {
        this.is_run = !1;
    ...
    this.trigger_keyup = function(c) {
        if (user.chat.open && 27 == c.keyCode)
            user.chat.quit();
            ...
            if (82 == c.keyCode)
                ...
                if (0 > user.craft.id) {
                    var d = c.keyCode - 49
                      , e = user.inv.can_select[d];
                    e && client.select_inv(e.id, d);
                }
            } else
                89 == c.keyCode && (user.bigmap = !user.bigmap);
        keyboard.up(c);
    }
    ;
    ...
    this.trigger_mouseup = function(c) {
        ...
        var d = user.chest
          , e = user.furnace;
        user.control.attack && (user.control.attack = 0,
        client.stop_attack());
