...
export class Items {
    ...
    static PICK_STONE = new Pickaxe(1, 30, 23, { pvp: 1, pve: 0 }, 2);
    ...
    static PICK_GOLD = new Pickaxe(7, 31, 23, { pvp: 3, pve: 1 }, 3);
    static PICK_DIAMOND = new Pickaxe(8, 32, 23, { pvp: 4, pve: 1 }, 4);
    ...
    static PICK_WOOD = new Pickaxe(15, 28, 22, { pvp: 5, pve: 1 }, 1);
    static WOOD_WALL = new EntityItem(16);
    static WOOD_SPIKE = new EntityItem(17);
    static MEAT = new Usable(18, 20, 0, -30, 0);
    static COOKED_MEAT = new Usable(19, 35, 0, 0, 0);
    static BIG_FIRE = new EntityItem(20);
    static BANDAGE = new Usable(21, 0, 0, 2, 7);
    ...
    static COAT = new Clothes(37, { pvp: 1, pve: 2 }, 0.35);
    ...
    static PICK_AMETHYST = new Pickaxe(51, 32, 23, { pvp: 5, pve: 2 }, 5);
    ...
    static CAP_SCARF = new Clothes(60, { pvp: 0, pve: 0 }, 0.1);
