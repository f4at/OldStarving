...
export class Items {
    ...
    static STONE_HELMET = new Clothes(43, { pvp: 2, pve: 8 }, 1);
    static GOLD_HELMET = new Clothes(44, { pvp: 4, pve: 13 }, 1);
    static DIAMOND_HELMET = new Clothes(45, { pvp: 5, pve: 19 }, 1);
    static BOOK = new Tool(46, 20, 25, { pvp: 3, pve: 1 });
    ...
    static AMETHYST_HELMET = new Clothes(81, { pvp: 6, pve: 23 }, 1);
